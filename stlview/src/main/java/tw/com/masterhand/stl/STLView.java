...
public class STLView extends GLSurfaceView {
    ...
    public STLView(Context context, STLObject stlObject) {
        super(context);
        SharedPreferences colorConfig = context.getSharedPreferences("colors", Activity
                .MODE_PRIVATE);
        STLRenderer.red = colorConfig.getFloat("red", 0.83f);
        STLRenderer.green = colorConfig.getFloat("green", 0.83f);
        STLRenderer.blue = colorConfig.getFloat("blue", 0.83f);
